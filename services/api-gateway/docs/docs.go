...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.TripsTodayResponse"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.VehiclesInTransitResponse"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.VerifyUserEmailRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.VerifyUserEmailResponse"
                        }
                    },
                    "400": {
                        "description": "Validation error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.ListDriversResponse"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/main.DriverResponse"
                        }
                    },
                    "400": {
                        "description": "Validation error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.UpdateDriverRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/fleet/drivers/{driverId}/status": {
            "patch": {
                ...
                "parameters": [
                    {
                        "description": "Driver status payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.UpdateDriverStatusRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.ListTripsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.CreateTripRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/main.TripResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/fleet/trips/{tripId}/complete": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Complete trip payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.CompleteTripRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/fleet/trips/{tripId}/start": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Start trip payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.ListAllVehiclesResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.UpdateVehicleRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/fleet/vehicles/{vehicleId}/status": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "description": "Vehicle status payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.UpdateVehicleStatusRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.ListUserOrganizationsResponse"
                        }
                    },
                    "401": {
        ...
        "/organizations/{orgId}/invite": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Invite user payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.InviteUserRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.InviteUserResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.GetOrganizationMembersListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.RemoveOrganizationMemberResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.UpdateMemberRoleBody"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.UpdateOrganizationMemberRoleResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.ValidateTokenResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
    ...
    "definitions": {
        ...
        "main.GetOrganizationMembersListResponse": {
            "type": "object",
            "properties": {
                "members": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/main.OrganizationMemberResponse"
                    }
                }
            }
        },
        ...
        "main.ListUserOrganizationsResponse": {
            "type": "object",
            "properties": {
                "organizations": {
                    "type": "array",
        ...
        "main.OrganizationMemberResponse": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "main.UpdateDriverStatusRequest": {
            "type": "object",
            "required": [
                "driver_id",
                "status"
        ...
        "main.UpdateOrganizationMemberRoleResponse": {
            "type": "object",
            "properties": {
                "success": {
                    "type": "boolean"
        ...
        "main.UpdateVehicleStatusRequest": {
            "type": "object",
            "required": [
                "status",
                "vehicle_id"
        ...
        "main.VehiclesInTransitResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
