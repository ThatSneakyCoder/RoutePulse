...
func main() {
	...
	log.Infow("organization service starting",
		"env", cfg.env,
	...
	log.Info("database connection established in organization service")
	...
	log.Infow("starting organization gRPC server",
	...
	log.Info("gracefully shutting down organization gRPC server")
