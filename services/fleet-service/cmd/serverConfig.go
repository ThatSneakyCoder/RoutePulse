...
import "github.com/ThatSneakyCoder/RoutePulse/shared/env"
...
func loadConfig() config {
	...
	cfg.grpcAddr = env.GetString("FLEET_SERVICE_PORT", "9092")
	...
	cfg.db.host = env.GetString("POSTGRES_HOST", "postgres-fleet")
